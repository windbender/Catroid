...
public class ProgramMenuActivity extends SherlockFragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String title = ProjectManager.getInstance().getCurrentSprite()
				.getName();
	...
	protected void onResume() {
		...
		if (ProjectManager.INSTANCE.getCurrentSpritePosition() == 0) {
			((Button) findViewById(R.id.program_menu_button_looks))
					.setText(R.string.backgrounds);
		} else {
			((Button) findViewById(R.id.program_menu_button_looks))
					.setText(R.string.looks);
		}
	}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == PreStageActivity.REQUEST_RESOURCES_INIT
			...
			Intent intent = new Intent(ProgramMenuActivity.this,
					StageActivity.class);
	...
	private void startScriptActivity(int fragmentPosition) {
		...
		intent.putExtra(ScriptActivity.EXTRA_FRAGMENT_POSITION,
				fragmentPosition);
		startActivity(intent);
	}
}
