...
public class LookAdapter extends ArrayAdapter<LookData> implements
	...
	public LookAdapter(final Context context, int textViewResourceId,
			ArrayList<LookData> items, boolean showDetails) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = View.inflate(context,
					R.layout.fragment_look_looklist_item, null);

			holder = new ViewHolder();

			holder.lookImageView = (ImageView) convertView
					.findViewById(R.id.look_image);
			holder.checkbox = (CheckBox) convertView
					.findViewById(R.id.look_checkbox);
			holder.lookNameTextView = (TextView) convertView
					.findViewById(R.id.look_name);
			holder.lookDetailsLinearLayout = (LinearLayout) convertView
					.findViewById(R.id.look_details);
			holder.lookFileSizeTextView = (TextView) holder.lookDetailsLinearLayout
					.findViewById(R.id.look_size);
		...
		if (lookData != null) {
			...
			if (showDetails) {
				if (lookData.getAbsolutePath() != null) {
					holder.lookFileSizeTextView.setText(getContext().getString(
							R.string.size)
							+ " "
							+ UtilFile.getSizeAsString(new File(lookData
									.getAbsolutePath())));
				}
				...
				if (!checkboxIsVisible) {
					resolutionString = getContext().getString(
							R.string.look_resolution)
							+ " " + resolutionString;
				}
