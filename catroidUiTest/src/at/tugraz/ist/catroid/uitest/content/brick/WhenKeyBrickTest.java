...
public class WhenKeyBrickTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {
	...
	public void testWhenBrick() {
		...
		UiTestUtils.addNewBrick(solo, UiTestUtils.getBrickCategory(solo, R.string.brick_xperia_play),
				R.string.brick_xperia_play, 1);
		...
		assertTrue("Wrong Script instance.",
				(ProjectManager.getInstance().getCurrentSprite().getScript(1) instanceof WhenKeyScript));
		...
		assertTrue("Wrong Script instance.",
				(ProjectManager.getInstance().getCurrentSprite().getScript(2) instanceof WhenKeyScript));
